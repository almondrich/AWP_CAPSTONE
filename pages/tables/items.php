                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <button class="btn btn-danger archive" data-id="<?php echo htmlspecialchars($rows['item_id']); ?>">Archive</button>
...
$(document).ready(function() {
    // Handle the "Archive" button click event
    $(document).on("click", ".archive", function() {
        var itemId = $(this).data('id'); // Fetch the data-id
        if (confirm('Are you sure you want to archive this item?')) {
            $.ajax({
                type: "POST",
                url: '../Actions/Items/archiveItem.php', // Update the URL to point to the archiving logic
                data: { 'item_id': itemId },
                success: function(response) {
                    alert(response); // Display success or error message
                    location.reload(); // Refresh the table
