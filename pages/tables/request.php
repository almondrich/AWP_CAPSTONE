...
?>
    <tr>
        <td><?php echo htmlspecialchars($rows[1]); ?></td>
        <td><?php echo htmlspecialchars($rows[2]); ?></td>
        <td><?php echo htmlspecialchars($rows[4]); ?></td>
        <td>
            <button class="btn btn-danger decrease" value="<?php echo htmlspecialchars($rows[0]); ?>">Decrease</button>
            <button class="btn btn-primary increase" value="<?php echo htmlspecialchars($rows[0]); ?>">Increase</button>
            <button class="btn btn-success delete" value="<?php echo htmlspecialchars($rows[0]); ?>">Delete</button>
        </td>
    </tr>
<?php
}
