...
$s=mysqli_query($con,"SELECT * FROM suppliers WHERE fullname='".$_POST['supplier']."'");
$rowsSup=mysqli_fetch_array($s);

if($count>0){
	while($rows=mysqli_fetch_array($q)){
		mysqli_query($con,"INSERT into stockin values (null,'".$_POST['code']."','".$rows[1]."','".$rowsSup[0]."','".$rows[3]."','".$_POST['date']."')");
