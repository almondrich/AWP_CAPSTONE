...
(35, 'Mongol Pencil', 'ppppp', 8, 1, 100, 0);
...
(103, 3, 35, 1, 100, 'POIUY', 'Pending', '2024-12-03 07:11:34', 'Pending', NULL, 'Pending', NULL, NULL, 0);
...
--
ALTER TABLE `requisitions`
  MODIFY `requisition_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;
